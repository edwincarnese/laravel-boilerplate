        ...
        <div class="modal-content">
            ...
            <div>
                <form action="javascript:void(0);" method="POST" role="form" id="form">
                    <div class="card-body">
                        <div class="row" id="form-fullname">
                        ...
                        <div class="row" id="form-credentials">
                            <div class="form-group col-md-6">
                        ...
                        <div class="row" id="form-passwords">
                            <div class="form-group col-md-6">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-primary" id="submit-form" form="form">Save</button>
            </div>
        </div>
    </div>
</div>